...
# Pricing from OpenRouter API (2026-02-21). Tuple: (input $/M, cache_read $/M, output $/M).
# Static fallback; live prices are fetched from OpenRouter on startup via fetch_openrouter_pricing().
_MODEL_PRICING_STATIC = {
    ...
    "openai/gpt-5.2-pro": (21.0, 2.1, 168.0),
    "openai/gpt-4.1": (2.0, 0.50, 8.0),
    "openai/gpt-4.1-mini": (0.4, 0.10, 1.6),
